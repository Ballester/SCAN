    ...
    for i, train_data in enumerate(train_loader):
        ...
        if opt.adapt_split != 'unlabeled':            
            with torch.no_grad():
                ...
                ema_adapt_cap_emb, _ = model_ema.txt_enc(adapt_caption, adapt_lens, dropout=opt.dropout_noise)
                adapt_cap_mb, _ = model.txt_enc(adapt_caption, adapt_lens, dropout=opt.dropout_noise)
